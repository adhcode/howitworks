...
export default function AddProperty() {
    ...
    const addFeature = () => {
        setFormData(prev => ({
            ...prev,
            keyFeatures: [...prev.keyFeatures, 'Type']
        }));
    };
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
                            <div className="flex-1">
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                                    ...
                                    <span className="text-[#703BF7] font-medium">Add Property</span>
                                </div>
                            </div>
                                ...
                                <form className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 lg:p-12 text-center">
                                            <FiUpload className="w-8 h-8 lg:w-12 lg:h-12 text-gray-400 mx-auto mb-4" />
                                            <p className="text-gray-600 mb-2 text-sm lg:text-base">Upload File Only PNG</p>
                                        </div>
                                    </div>
