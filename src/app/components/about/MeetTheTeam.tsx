                ...
                {TEAM_MEMBERS.map((member, index) => (
                    <div key={index} className="bg-white rounded-[32px] overflow-hidden">
                        ...
                        <div className="pt-14 p-6">
                            <h3 className="text-xl font-semibold text-[#1A2A52] mb-1">
                                {member.name}
                            </h3>
                            <p className="text-base text-[#3A3A3C] mb-6">
                                {member.role}
                            </p>
                            <div className="flex items-center justify-between bg-[#F4F5F7] rounded-full p-2">
                                <button className="flex items-center gap-2 text-[#1A2A52] hover:text-[#1FD2AF] transition-colors px-4">
                                    <span>Say Hello</span>
                                    <span role="img" aria-label="wave">👋</span>
                                </button>
                                <button className="w-10 h-10 bg-[#1FD2AF] rounded-full flex items-center justify-center hover:bg-[#1AB89A] transition-colors group">
