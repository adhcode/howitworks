    ...
    const fetchProfile = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setProfile(data.investor);
          setFormData({
            phoneNumber: data.investor.phoneNumber || '',
            address: data.investor.address || '',
            investmentBudget: data.investor.investmentBudget?.toString() || '',
            preferredLocation: data.investor.preferredLocation || '',
          });
        }
      } catch (error) {
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-1">
                  <textarea
                    rows={3}
                    value={editing ? formData.address : (profile.address || 'Not provided')}
