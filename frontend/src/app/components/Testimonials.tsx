...
const Testimonials = () => {
    ...
    // Show only current testimonial on mobile, all on desktop
    const displayedTestimonials = isMobile ? [TESTIMONIALS[currentIndex]] : TESTIMONIALS;
        ...
        <section className="py-16 sm:py-20 px-4 lg:px-16 bg-[#F4F5F7]">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8 sm:mb-12 gap-4">
                    <div>
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#2E2E2E] mb-3 sm:mb-4">What Our Clients Say</h2>
