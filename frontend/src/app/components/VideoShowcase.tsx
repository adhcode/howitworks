            ...
            <div className={`fixed bottom-6 right-6 z-40 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-12 scale-95 pointer-events-none'
                ...
                <div className="group relative">
                    ...
                    >
                        ...
                        {/* Content */}
                        <div className="p-4">
                            <h3 className="text-[#1A2A52] font-bold text-base mb-2 line-clamp-1">
                                {videoData.title}
                            </h3>
                            <p className="text-[#3A3A3C] text-sm line-clamp-2 mb-3 leading-relaxed">
                                Experience luxury properties with guided tours
                            </p>
                            <div className="flex items-center justify-between">
                                <span className="text-[#1A2A52] text-sm font-semibold">Watch Tour</span>
                                <div className="w-6 h-6 rounded-full bg-[#1A2A52] flex items-center justify-center group-hover:bg-[#1FD2AF] transition-colors">
