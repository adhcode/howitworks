...
const Footer = () => {
    return (
        <footer className="bg-[#ffffff] border-t border-[#0F1A3A] mt-12">
            {/* Top CTA Section */}
            <div className="relative border-b border-[#0F1A3A] py-12 overflow-hidden">
                {/* Left Abstract Image */}
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-0 w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-10">
                    <div className="flex-1">
                        <h2 className="text-[28px] sm:text-[32px] md:text-[38px] font-bold text-[#1A2A52] mb-3">Start Your Real Estate Journey Today</h2>
                        <p className="text-[#000000] text-base sm:text-lg font-medium max-w-[520px] leading-relaxed">How it works is a modern real estate platform that connects clients with verified realtors to help them find their dream properties across Nigeria.
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-0 py-12 sm:py-16">
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div className="col-span-2 md:col-span-3 lg:col-span-1">
                        <div className="flex items-center gap-3 mb-4">
                            <Image
                                ...
                                className="w-8 h-8"
                            />
                            <div className="text-2xl font-extrabold text-white">Howitworks</div>
                        </div>
                        ...
                        <form className="relative mb-4 max-w-[320px]">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-12 py-2.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1FD2AF] text-[15px] bg-white"
                            />
                            <button
                                type="submit"
                    ...
                    {/* Links Sections */}
                    <div>
                        <div className="font-semibold text-lg mb-4 text-[#0F1A3A]">Home</div>
                        <ul className="space-y-2.5 text-[#000000] text-base">
                    ...
                    <div>
                        <div className="font-semibold text-lg mb-4 text-[#0F1A3A]">About Us</div>
                        <ul className="space-y-2.5 text-[#000000] text-base">
                    ...
                    <div>
                        <div className="font-semibold text-lg mb-4 text-[#0F1A3A]">Properties</div>
                        <ul className="space-y-2.5 text-[#000000] text-base">
                    ...
                    <div>
                        <div className="font-semibold text-lg mb-4 text-[#0F1A3A]">Contact Us</div>
                        <ul className="space-y-2.5 text-[#000000] text-base">
            ...
            {/* Bottom Bar */}
            <div className="border-t border-[#0F1A3A] bg-[#0F1A3A]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-base text-gray-300">
